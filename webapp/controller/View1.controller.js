        ...
        classifyZip: function(oEvent){
            ...
            xhr.addEventListener("readystatechange", function () {
                if (this.readyState === this.DONE) {
                    ...
                    cellValues[0][1] = json.predictions[0].results[1].label[0];
                    cellValues[0][2] = json.predictions[0].results[2].label[0];
                    
                    cellValues[1][0] = json.predictions[0].results[3].label[0];
                    cellValues[1][1] = json.predictions[0].results[4].label[0];
                    cellValues[1][2] = json.predictions[0].results[5].label[0];
                    
                    cellValues[2][0] = json.predictions[0].results[6].label[0];
                    cellValues[2][1] = json.predictions[0].results[7].label[0];
                    cellValues[2][2] = json.predictions[0].results[8].label[0];
